...
(function() {
  ...
  async function getPresignedUrlS3List(config) {
    ...
    // DEBUG: log canonical request details
    console.log('[IDriveThumb:SigV4] CR lines (List):');
    crParts.forEach((p, i) => console.log('[IDriveThumb:SigV4]  ' + i + ':', JSON.stringify(p)));
    console.log('[IDriveThumb:SigV4] CR (List):', JSON.stringify(canonicalRequest));
  ...
  window.E2C_S3 = {
    ...
    getPresignedUrlList: getPresignedUrlS3List
  };
